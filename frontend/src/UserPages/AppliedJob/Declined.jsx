...
export const Declined = () => {
  ...
  const pendingfilter=applied.filter((app)=> app.status==="rejected" ) 
  ...
  if (pendingfilter.length === 0) {
    return (
      ...
      <div className="appliedjobbody pt-[100px] w-[80%] ml-[120px]">
        <h2 className='text-2xl font-bold ml-[40%] mt-[10px] pb-[30px]'>No Declined Applications 🙂</h2>
        <AppliedNavbar />
        <div className="noapplication">
         <img src={empty} className="h-[400px] w-[500px] ml-[300px] mt-[-40px]"/>
         <h2 className="text-2xl font-bold mt-[-20px] ml-[300px]">No applications declined. Keep Tracking.</h2>
        </div>
      </div>
      </>
    );
  ...
  return (
    ...
    <UserNavbar/>
        <div className="appliedjobbody pt-[100px] w-[80%] ml-[120px]"> 
        <h2 className='text-2xl font-bold ml-[38%] mt-[10px] pb-[30px]'>Oops! <span className='text-red-500'>Declined</span> Applications 😞</h2>
        ...
        {pendingfilter.map((app)=>(
          <div className="appliedcontainer ml-[150px] mb-6" key={app.aid}>
            ...
            <h3 className="mt-[10px] font-medium text-red-500">{app.status}</h3>
