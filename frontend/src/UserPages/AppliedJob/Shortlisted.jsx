...
export const Shortlisted = () => {
  ...
  if (pendingfilter.length === 0) {
    return (
      ...
      <div className="appliedjobbody pt-[100px] w-[80%] ml-[120px]">
        <h2 className='text-2xl font-bold ml-[40%] mt-[10px] pb-[30px]'>No shortlisted Applications 🙂</h2>
        <AppliedNavbar />
  ...
  return (
    ...
    <UserNavbar/>
        <div className="appliedjobbody pt-[100px] w-[80%] ml-[120px]"> 
        <h2 className='text-2xl font-bold ml-[37%] mt-[10px] pb-[30px]'>Aww! <span className='text-green-500'>Shortlisted</span> applications 🎉</h2>
