...
export const UserNavbar = () => {
  ...
  return (
    <div className="usernavbar h-[70px]" >
        ...
        <div className="usernavright mt-[15px] ml-[560px]">
            <div className="navtext mt-[5px]" onClick={()=>{navigate('/user/home')}}>
                <h3>Home</h3>
            </div>
            ...
            <div className="navtext ml-[50px] mt-[5px]" onClick={()=>{navigate('/login')}}>
                <h3>Logout</h3>
            </div>
        </div>
    </div>
