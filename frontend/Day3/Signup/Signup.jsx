    ...
    <div className="signupbody">
        ...
        <div className="signupbox flex flex-col gap-5 justify-center items-center h-[563px] mt-6">
            <div className="sinname">
                ...
                <input className="sin h-[30px] mt-1" type="text" placeholder="Enter your name" />
            </div>
            <div className="sinemail">
                <label>Email ID<span className='text-red-500'>*</span></label>
                <input className="sin h-[30px] mt-1" type="text" placeholder="Enter your email" />
            ...
            <div className="sinpassword">
                ...
                <input className="sin h-[30px] mt-1"  type="text" placeholder="Enter your password" />
            </div>
            <div className="sinmobile">
                <label>Number<span className='text-red-500'>*</span></label>
                <input className="sin h-[30px] mt-1"  type="text" placeholder="Enter your phone Number" />
            ...
            <div className="sinpos" style={{marginLeft:'-40px'}}>
                ...
                <input type="radio" id="option1" name="radioGroup" className="mt-3  "/><label>Student</label>
                <input type="radio" id="option4" name="radioGroup" style={{marginLeft:'10px'}}  className="mt-3 "/><label>Employee</label>
                <input type="radio" id="option4" name="radioGroup" style={{marginLeft:'10px'}}  className="mt-3 "/><label>HR</label>
            </div>
            <button  className="sbut mt-[-10px]">signup</button>
