...
const Privacy = () => {
  return (
    <div>
      <div style={{border:"2px solid white",width:"60%",marginLeft:"20%"}}>
        <h2 style={{color:"blue",marginLeft:"38%",padding:"3%"}}>PRIVACY POLICY</h2>
        <h1 style={{fontWeight:"bold"}}>1. Introduction</h1>
...
We, at Info Edge (India) Limited and our affiliated companies worldwide (hereinafter collectively referred to as "IEIL"), are committed to respecting your online privacy and recognize the need for appropriate protection and management of any personally identifiable information you share with us. This Privacy Policy ("Policy") describes how IEIL collects, uses, discloses and transfers personal information of users through its websites and applications, including through www.naukri.com, mobile applications and online services (collectively, the "Platform"). This policy applies to those who visit the Platform, or whose information IEIL otherwise receives in connection with its services (such as contact information of individuals associated with IEIL including partners) (hereinafter collectively referred to as "Users"). For the purposes of the Privacy Policy, "You" or "Your" shall mean the person who is accessing the Platform.
 ...
 <h1 style={{fontWeight:"bold"}}>2. Types of Personal Information collected by IEIL</h1>
...
<h1 style={{fontWeight:"bold"}}>3. How IEIL may use your Personal Information</h1>
...
<h1 style={{fontWeight:"bold"}}>4. Cookies and Other Tracking Technologies</h1>
...
<h1 style={{fontWeight:"bold"}}>5. The Basis/ Grounds which we rely on for collection and processing of your Personal Information:</h1>
...
<h1 style={{fontWeight:"bold"}}>6. Information Sharing and Disclosure</h1>
...
<h1 style={{fontWeight:"bold"}}>7. Third Party Content:</h1>
...
<h1 style={{fontWeight:"bold"}}>8. Children</h1>
...
<h1 style={{fontWeight:"bold"}}>9. Retention of Personal Information</h1>
...
<h1 style={{fontWeight:"bold"}}>10. Controlling your personal information</h1>
...
At any time, if you wish to delete your account on naukri.com, you may do so by using the settings available in your account.

<h1 style={{fontWeight:"bold"}}>11. Social media</h1>
...
<h1 style={{fontWeight:"bold"}}>12. Changes to this Privacy Policy</h1>
...
<h1 style={{fontWeight:"bold"}}>13. Disclaimer</h1>
