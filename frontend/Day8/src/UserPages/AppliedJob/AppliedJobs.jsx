...
import { deleteapply, getuserdatabyid } from "../../Service/api";
        ...
        <div className="appliedbox">
          {applied.applications.map((app) => (
            <div className="appliedcontainer ml-[150px] mb-6" key={app.aid}>
              ...
              <h3 className="mt-[10px] font-medium text-gray-800">{app.status === null ? "pending" : app.status === "selected" ? "selected" : "declined"}</h3>
