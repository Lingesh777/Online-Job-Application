...
//         <div className="landnavleft mt-[-30px] font-bold">
//           <h4 style={{color:"white",marginLeft:"40%",marginTop:"-2.5%"}}>Job</h4>
//           <h4 style={{color:"white",marginTop:"-1.5%",marginLeft:"10%"}}>Companies</h4>
//           <h4 style={{color:"white",marginTop:"-1.5%",marginLeft:"20%"}}>Services</h4>
//           <h4 style={{color:"white",marginTop:"-1.5%",marginLeft:"85%",cursor:"pointer"}} onClick={handlelog}>Login</h4>
