...
import { editstatus, getapply, getapplybyid, getuserapply } from '../../Service/api';
...
export const ApplicationReceived = () => {
  ...
  const filteredApply = apply.filter(job => {
    ...
    return ((selectedFiltersLowerCase.includes(jobTitleLowerCase) || selectedFiltersLowerCase.includes(jobLocationLowerCase)) && (job.status === null || job.status === "null"));
  });
  ...
  //       emailjs.send('service_e8l32up', 'template_u0y36rf', {
  //         user_name: uname,
  //         to_email: email,
  //         job_role: jobtitle,
  //         org_name: orgname,
  //         message: 'Your application has been shortlisted', // This is where you define the message
  //       }, 'Ao6DAsfBzy69RGoAL')
  //       .then((response) => {
  ...
  //         job_role: jobtitle,
  //         org_name: orgname,
  //         message: 'Your application has been declined.Thank you for your interest.',
  //       }, 'Ao6DAsfBzy69RGoAL')
  //       .then((response) => {
  //         console.log('Email sent successfully:', response);
  //       }, (error) => {
  ...
  if(filteredApply.length < 1)
  {
    ...
    <AdminTopbar/>
      ...
      <div className="applicationbody mt-[100px] ml-[350px] w-[800px]">
        ...
        <div className="filter-box fixed">
