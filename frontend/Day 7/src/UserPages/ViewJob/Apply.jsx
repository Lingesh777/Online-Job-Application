...
export const Apply = () => {
    ...
    const[apply,setApply]=useState({
        name:'',jobtitle:'',joblocation:'',jobtype:'',cgpa:'',jobexperience:'',dob:'',projects:'',jobdescription:'',resume:'',skills:[],user_uid:''
    })
  ...
  return (
    <>
        ...
        <h2 className='text-3xl font-bold ml-[350px] mb-[30px]'>{job.jobtitle}</h2>
